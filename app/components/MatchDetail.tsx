                        ...
                        <div key={pi}>
                          ...
                          <div className="hidden md:grid grid-cols-[2rem_1.8rem_1fr_4.5rem_3.5rem_4rem_3rem_3rem_10rem] gap-1 px-2 py-1 items-center hover:bg-white/5 text-xs">
                            ...
                            <div className="text-center">
                              ...
                              <span className="text-[#4a5a70] ml-1">({pKda})</span>
                            </div>
                            <div className="text-[#8a9bb0] text-center">{p.cs}</div>
                            <div className="text-[#8a9bb0] text-center">{(p.damageDealtToChampions / 1000).toFixed(1)}k</div>
                            <div className="text-[#c89b3c] text-center">{(p.goldEarned / 1000).toFixed(1)}k</div>
                            <div className="text-[#8a9bb0] text-center">{p.visionScore}</div>
                          ...
                          <div className="md:hidden grid grid-cols-[1.5rem_1fr_4rem_3rem] gap-1 px-2 py-1 items-center hover:bg-white/5 text-xs">
                            ...
                            <div className="text-[#8a9bb0] text-center text-xs">{p.cs}</div>
                          </div>
                        </div>
                      );
                    })}
