...
const translations = {
  ...
  'tft.comp.skillCap': t6('Skill-Cap-Index', 'Skill cap', '\uC2E4\uB825 \uACA9\uCC28', '\u64CD\u4F5C\u4E0A\u9650', 'Techo de habilidad', 'Plafond skill'),
  'tft.comp.skillCap.execution': t6('Execution-Comp', 'Execution comp', '\uC2E4\uD589 \uC758\uC874', '\u6267\u884C\u4F9D\u8D56\u578B', 'Comp de ejecuci\u00F3n', 'Comp d\u2019ex\u00E9cution'),
  ...
  'tft.filter.velocity48h':t6('vs vor 3 Tagen', 'vs 3 days ago', '3\uC77C \uC804 \uB300\uBE44', '\u5BF93\u5929\u524D', 'vs hace 3 d\u00EDas', 'vs il y a 3 jours'),
  ...
  'tft.tempo.tooltip': t6(
    'Wie schnell du levelst. (\u00D8 Level \u2212 6) \u00F7 3 \u00D7 100. Lvl 9 \u2192 100, Lvl 6 \u2192 0.',
    'How fast you level. (Avg Level \u2212 6) \u00F7 3 \u00D7 100. Lvl 9 \u2192 100, Lvl 6 \u2192 0.',
    '\uB808\uBCA8\uC5C5 \uC18D\uB3C4. (\uD3C9\uADE0 \uB808\uBCA8 \u2212 6) \u00F7 3 \u00D7 100. Lv9 \u2192 100, Lv6 \u2192 0.',
    '\u5347\u7EA7\u901F\u5EA6\u3002(\u5E73\u5747\u7B49\u7EA7 \u2212 6) \u00F7 3 \u00D7 100\u30029\u7EA7 \u2192 100\uFF0C6\u7EA7 \u2192 0\u3002',
    'Velocidad de subida. (Nivel medio \u2212 6) \u00F7 3 \u00D7 100. Nv 9 \u2192 100, Nv 6 \u2192 0.',
    'Vitesse de progression. (Niveau moy. \u2212 6) \u00F7 3 \u00D7 100. Nv 9 \u2192 100, Nv 6 \u2192 0.',
  ),
  'tft.eco.tooltip': t6(
    'Slam-Disziplin. Niedriges Restgold = sauber rausgespielt. 5g \u2192 100, 25g \u2192 0.',
    'Slam discipline. Low leftover gold = clean spend-out. 5g \u2192 100, 25g \u2192 0.',
    '\uC2AC\uB7A8 \uB514\uC2DC\uD50C\uB9B0. \uB0A8\uC740 \uACE8\uB4DC\uAC00 \uC801\uC744\uC218\uB85D \uAE54\uB054. 5g \u2192 100, 25g \u2192 0.',
    '\u88C5\u5907\u7EC4\u5408\u7EAA\u5F8B\u3002\u5269\u4F59\u91D1\u5E01\u8D8A\u5C11\u8D8A\u597D\u30025\u91D1 \u2192 100\uFF0C25\u91D1 \u2192 0\u3002',
    'Disciplina de slam. Menos oro restante = mejor uso. 5 \u2192 100, 25 \u2192 0.',
    'Discipline de slam. Peu d\'or restant = bien d\u00E9pens\u00E9. 5 \u2192 100, 25 \u2192 0.',
  ),
  'tft.damage.tooltip': t6(
    '\u00D8 Schaden an Mitspielern (Spieler-HP). \u00D8 Damage \u00F7 2. 200 DMG \u2192 100.',
    'Avg damage to other players (player HP). Avg Damage \u00F7 2. 200 DMG \u2192 100.',
    '\uB2E4\uB978 \uD50C\uB808\uC774\uC5B4\uC5D0\uAC8C \uC900 \uD3C9\uADE0 \uD53C\uD574. \uD3C9\uADE0 \uD53C\uD574 \u00F7 2. 200 \u2192 100.',
    '\u5BF9\u5176\u4ED6\u73A9\u5BB6\u7684\u5E73\u5747\u4F24\u5BB3\u3002\u5E73\u5747\u4F24\u5BB3 \u00F7 2\u3002200 \u2192 100\u3002',
    'Da\u00F1o medio a otros jugadores. \u00D8 Da\u00F1o \u00F7 2. 200 \u2192 100.',
    'D\u00E9g\u00E2ts moy. aux autres joueurs. Moy. \u00F7 2. 200 \u2192 100.',
  ),
  'tft.survival.tooltip': t6(
    'Wie weit oben du endest. (9 \u2212 \u00D8 Platz) \u00F7 8 \u00D7 100. Platz 1 \u2192 100, Platz 9 \u2192 0.',
    'How high you finish. (9 \u2212 Avg Place) \u00F7 8 \u00D7 100. Place 1 \u2192 100, Place 9 \u2192 0.',
    '\uCD5C\uC885 \uC21C\uC704. (9 \u2212 \uD3C9\uADE0 \uC21C\uC704) \u00F7 8 \u00D7 100. 1\uC704 \u2192 100, 9\uC704 \u2192 0.',
    '\u6700\u7EC8\u540D\u6B21\u3002(9 \u2212 \u5E73\u5747\u540D\u6B21) \u00F7 8 \u00D7 100\u3002\u7B2C1 \u2192 100\uFF0C\u7B2C9 \u2192 0\u3002',
    'Posici\u00F3n final. (9 \u2212 Pos. media) \u00F7 8 \u00D7 100. 1\u00BA \u2192 100, 9\u00BA \u2192 0.',
    'Position finale. (9 \u2212 Place moy.) \u00F7 8 \u00D7 100. 1\u00E8re \u2192 100, 9\u00E8me \u2192 0.',
  ),
  'tft.consistency.tooltip': t6(
    'Top-4-Quote. Top-4-Spiele \u00F7 Gesamtspiele \u00D7 100.',
    'Top-4 rate. Top-4 games \u00F7 total games \u00D7 100.',
    'Top-4 \uBE44\uC728. Top-4 \uACBD\uAE30 \u00F7 \uC804\uCCB4 \uACBD\uAE30 \u00D7 100.',
    'Top 4 \u6BD4\u7387\u3002Top 4 \u573A\u6B21 \u00F7 \u603B\u573A\u6B21 \u00D7 100\u3002',
    'Tasa Top 4. Partidas Top 4 \u00F7 partidas totales \u00D7 100.',
    'Taux Top 4. Parties Top 4 \u00F7 parties totales \u00D7 100.',
  ),
