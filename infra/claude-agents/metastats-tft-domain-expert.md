...
- `public/tft-assets-{set}.json` (Champions, Traits, Items, Augments, Tiers)
- `public/tft-gods-{set}.json`
- `public/tft-comp-guides-{set}.json`
- `public/tft-augment-tiers-{set}.json`

**TFT-Memory (Domain-Knowledge):**
- `reference_tft_spielmechanik_universal.md` (set-stable Mechanik)
- `reference_tft_spielmechanik_set17.md` (set-spezifische Schwellen, Pointer auf Bundle)
- `reference_tft_spielerworkflow.md` (Stage-für-Stage Entscheidungen)
- `reference_tft_konkurrenz_ux.md` (Konkurrenz-Patterns)
- `reference_tft_set17_knowledge_index.md` (Trait-Klassen-Übersicht + Bundle-Pointer)
- `reference_tft_aggregation_hierarchy.md` (Cluster-Key-Konsolidierung)
- `reference_tft_match_v1_schema.md` (Cache vs Raw DTO)
- `reference_tft_asset_quirks.md` (Bundle-Gotchas)
- `reference_tft_data_depth.md` (wo welche Daten leben)
- `reference_tft_damage_limitation.md` (kein Combat-Damage)

**TFT-Feedback (Pflicht-Regeln):**
- `feedback_no_augment_stats.md`
- `feedback_verify_before_classification_claims.md`
- `feedback_think_family_aggregation_deeply.md`
- `feedback_user_override_family_aggregation_2026_06_21.md`

**Konkurrenz on-demand:**
- WebFetch zu MetaTFT-Comp-Detail-URL, tactics.tools-Comp, tftacademy-Tierlist-Eintrag wenn UX-Vergleich angefragt
