    ...
    <main className="min-h-screen bg-[#0e1525] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          ...
          <p className="text-[#a0b0c5] text-sm mb-8">{t('notFound.text')}</p>
          <div className="flex flex-col sm:flex-row gap-2 justify-center">
            ...
            <a href="/leaderboard" className="border border-[#2a3a50] hover:border-[#c89b3c] text-[#a0b0c5] hover:text-white text-sm px-6 py-2.5 rounded-lg transition-colors">
              {t('nav.leaderboard')}
            </a>
          </div>
        </div>
